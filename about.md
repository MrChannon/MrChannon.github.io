...
- [x] Develop a novel object detection system equipped with NPU for onboard and real-time performance on UAVs.
...
- [x] The final global optimum is obtained by traversing all the sub-populations.
...
<img src="./pics/about/plane.jpg" width = "260" align='left'/>
...
1. Zhang, Y., & **Chen, L.** (2018, May). A Hybrid Forecasting Model Based on Modified
...
2. Wang, D., Li, L., & **Chen, L.** (2019, June). An Efficient Genetic Algorithm for Active
